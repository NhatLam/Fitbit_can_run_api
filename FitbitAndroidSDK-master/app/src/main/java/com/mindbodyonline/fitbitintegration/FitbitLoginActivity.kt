...
import com.mindbodyonline.fitbitsdk.service.api.BodyAndWeightService
...
class FitbitLoginActivity : AppCompatActivity(), AuthenticationHandler {
    ...
    override fun onResume() {
        ...
        button_getinfo.setOnClickListener {
            onLoggedIn()
        }
    }
    ...
    fun onLoggedIn(){
        ...
        fService.getBodyAndWeightService().weight_0("2019/11/25","2019/11/26").enqueue(object : Callback<String> {
